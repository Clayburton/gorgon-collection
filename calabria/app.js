/* CKDesign — product page: Medusa, Calabria Italy (CK_003).
...
import PHOTOS from './photos.js?v=4';   // bump when photos.js is regenerated

const PIECE = {
  file: '../assets/calabria.glb', assetV: 6,
  cartUrl: 'https://clayandkelsy.com/cart/?add-to-cart=6379',   // WooCommerce product 6379
  ...
  dims: { mm: '55 &times; 51 mm', in: '2.2&Prime; &times; 2.0&Prime;',
          deep: '18 mm (0.7&Prime;) deep' },
  ...
  siblings: [
    ...
    { name: 'Medusa, Southern Italy', date: '500 BCE', price: '$42',
      thumb: '../assets/thumbs/southern.webp?v=3',
...
// no photos yet → hide the whole section (auto-appears once photos.js is filled)
if (!PHOTOS.length) document.getElementById('gallery').hidden = true;
PHOTOS.forEach((p, i) => {
