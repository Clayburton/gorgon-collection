/* CKDesign — product page: Athena / Minerva (CK_001, The Odyssey).
...
const PIECE = {
  file: '../assets/athena.glb', assetV: 1,
  cartUrl: 'https://clayandkelsy.com/cart/?add-to-cart=6336',   // WooCommerce product 6336
  ...
  dims: { mm: '29 &times; 63 mm', in: '1.1&Prime; &times; 2.5&Prime;',
          deep: '23 mm (0.9&Prime;) deep' },
  ...
  set: { name: 'Odyssey', count: 'four', was: '$160', now: '$120.00', off: '25%',
         cart: 'https://clayandkelsy.com/cart/?add-to-cart=2652' +
               '&quantity[6417]=1&quantity[6336]=1&quantity[6397]=1&quantity[6399]=1' },
  siblings: [
    { name: 'Odysseus, King of Ithaca', date: 'Homer’s Odyssey', price: '$42',
      thumb: '../assets/thumbs/odysseus.webp?v=3',
      url:  'https://clayandkelsy.com/odysseus-king-of-ithaca/',
      cart: 'https://clayandkelsy.com/cart/?add-to-cart=6417' },
    { name: 'Polyphemus, The Cyclops', date: '2nd century', price: '$42',
      thumb: '../assets/thumbs/cyclops.webp?v=3',
    ...
    { name: 'Polyphemus, The Shepherd', date: '2nd century', price: '$38',
      thumb: '../assets/thumbs/shepherd.webp?v=3',
...
const P = {
  ...
  backdrop: { center:'#dedad3', edge:'#cbc7c0', vein:'#767269', veinAmount:0.26,
              grain:11, seed:22, lightX:0.46, lightY:0.34 },
...
async function boot3D() {
  ...
  new GLTFLoader().setMeshoptDecoder(MeshoptDecoder).load(PIECE.file + '?v=' + PIECE.assetV, (gltf) => {
    ...
    if (PIECE.flip) geo.rotateY(Math.PI);   // some scans import upside-down
