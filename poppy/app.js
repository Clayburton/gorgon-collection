/* CKDesign — product page: Poppy (CK_014, The Eleusinian Mysteries).
...
const PIECE = {
  file: '../assets/poppy.glb', assetV: 1,
  flip: true,   // same 180° flip the collection room applies — scan is upside-down
  cartUrl: 'https://clayandkelsy.com/cart/?add-to-cart=6413',   // WooCommerce product 6413
  ...
  dims: { mm: '52 &times; 52 mm', in: '2.0&Prime; &times; 2.0&Prime;',
          deep: '9 mm (0.4&Prime;) deep' },
  ...
  siblings: [
    { name: 'Wheat Sheaf', date: '1st c. BCE', price: '$27',
      thumb: '../assets/thumbs/grain.webp?v=3',
...
const P = {
  ...
  backdrop: { center:'#f6eef1', edge:'#e6d8dd', vein:'#c9b4bd', veinAmount:0.15,
              grain:9, seed:41, lightX:0.5, lightY:0.38 },
