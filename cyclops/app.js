/* CKDesign — product page: Polyphemus, The Cyclops (CK_005, The Odyssey).
...
const PIECE = {
  file: '../assets/cyclops.glb', assetV: 1,
  cartUrl: 'https://clayandkelsy.com/cart/?add-to-cart=6397',   // WooCommerce product 6397
  ...
  siblings: [
    ...
    { name: 'Athena / Minerva', date: '1st–2nd century AD', price: '$38',
      thumb: '../assets/thumbs/athena.webp?v=3',
...
const P = {
  ...
  backdrop: { center:'#dedad3', edge:'#cbc7c0', vein:'#767269', veinAmount:0.26,
              grain:11, seed:23, lightX:0.46, lightY:0.34 },
