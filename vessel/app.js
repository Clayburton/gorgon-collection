/* CKDesign — product page: Sacred Vessel (CK_015, The Eleusinian Mysteries).
...
const PIECE = {
  ...
  cartUrl: 'https://clayandkelsy.com/cart/?add-to-cart=6415',   // WooCommerce product 6415
...
const P = {
  ...
  backdrop: { center:'#f6eef1', edge:'#e6d8dd', vein:'#c9b4bd', veinAmount:0.15,
              grain:9, seed:45, lightX:0.5, lightY:0.38 },
